...
import chatAppImg from 'public/chat-app-preview.webp'
...
import SocketIOBadge from '../Badges/SocketIOBadge'
        ...
        <div className='flex flex-col justify-between lg:h-[380px]'>
          ...
          <footer className='flex justify-between items-center mt-4'>
            <p className='font-bold text-gray-900 dark:text-white flex items-center'>
              ...
              <span>{t('CHAT_APP_CREATION_DATE')}</span>
            </p>
            <OfflineStatus />
          </footer>
        </div>
