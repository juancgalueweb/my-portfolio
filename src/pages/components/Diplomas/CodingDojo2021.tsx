  ...
  return (
    <li className='mb-10 ml-6'>
      ...
      <Image
        ...
        alt='Coding Dojo diploma image'
        className='w-[400px] h-auto rounded-lg shadow-md mb-4'
        placeholder='blur'
      />
      <a
        href='https://certifications-and-courses.s3.sa-east-1.amazonaws.com/CodingDojo/Certificado+MERN+-+Juan+Carlos+Galue.pdf'
        target='_blank'
