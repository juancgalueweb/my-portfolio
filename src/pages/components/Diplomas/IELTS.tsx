...
import IeltsPic from 'public/diplomas/ielts-preview.jpg'
...
const IELTS = () => {
  ...
  return (
    <li className='mb-10 ml-6'>
      ...
      <Image
        src={IeltsPic}
        alt='Academic Ielts test results image'
        className='w-[400px] h-auto rounded-lg shadow-md mb-4'
        placeholder='blur'
      />
      <a
        href='https://certifications-and-courses.s3.sa-east-1.amazonaws.com/IELTS.pdf'
        target='_blank'
